...
interface Props { job: AnnotatedJob; index: number; onGenerate: (style: ImageStyle) => void; onSkip: () => void; }
      ...
      <div className="p-4">
        ...
        {!isDone && !isSkipped ? (
          <div className="flex flex-col gap-2">
            ...
            <button onClick={onSkip} className="w-full flex items-center justify-center gap-2 py-2 rounded-xl text-xs text-white/30 hover:text-white/60 transition-colors">
